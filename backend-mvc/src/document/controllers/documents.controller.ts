...
export class DocumentManagementController {
  ...
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  async findDelegationByDocument(
    ...
    try {
      ...
      console.log(
        '🔧 No delegation found, creating new delegation for document:',
        documentId,
      );
  ...
  async updateFile(
    ...
    try {
      const result = await this.documentManagementService.updateFile(
        id,
        updateData,
        userId,
      );
  ...
  async deleteFile(
    ...
    try {
      const result = await this.documentManagementService.deleteFile(
        id,
        userId,
      );
